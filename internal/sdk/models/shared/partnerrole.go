...
type PartnerRole struct {
	...
	VendorEnforcedUserLimit *int64 `json:"vendor_enforced_user_limit,omitempty"`
}
...
func (p *PartnerRole) GetVendorCreated() *bool {
	if p == nil {
		return nil
	}
	return p.VendorCreated
}

func (p *PartnerRole) GetVendorEnforcedUserLimit() *int64 {
	if p == nil {
		return nil
	}
	return p.VendorEnforcedUserLimit
}
