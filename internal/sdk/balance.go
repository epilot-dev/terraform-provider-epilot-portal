...
func newBalance(rootSDK *SDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Balance {
	return &Balance{
		rootSDK:          rootSDK,
...
func (s *Balance) GetCustomerBalance(ctx context.Context, opts ...operations.Option) (*operations.GetCustomerBalanceResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/v2/portal/billing/customers/balance")
	if err != nil {
