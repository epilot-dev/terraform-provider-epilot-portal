...
// Generated from OpenAPI doc version 1.2.1 and generator version 2.918.3
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		SDKVersion: "0.27.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/terraform 0.27.0 2.918.3 1.2.1 github.com/epilot-dev/terraform-provider-epilot-portal/internal/sdk",
